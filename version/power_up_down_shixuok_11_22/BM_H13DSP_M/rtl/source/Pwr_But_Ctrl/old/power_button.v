...
//assign lbtn_pwrdown_evt_in  = force_off	& ~i_p0_slp_s5_n;			//230225 L00289
assign lbtn_pwrdown_evt_in  = reg_lbtn_n	& ~i_p0_slp_s5_n;			//230225 L00289
...
begin
  ...
  begin
    force_off       <= 1'b1;
	force_off_count <= force_off_count + 1'b1;				//230225 L00289
  end
  else if (force_off_count == 3'b100)//5s		//230225 L00289
  begin
    reg_lbtn_n		<= 1'b1;
  end
