...
//I2C
input  wire        i_MCIO01A_ALERT_R_N	               , //addr 0x0012  bit7
input  wire        i_MCIO01C_ALERT_R_N	               , //addr 0x0012  bit6
input  wire        i_MCIO11A_ALERT_R_N                 , //addr 0x0012  bit5
input  wire        i_MCIO11C_ALERT_R_N                 , //addr 0x0012  bit4
input  wire        i_MCIO21A_ALERT_R_N	               , //addr 0x0012  bit3
input  wire        i_MCIO21C_ALERT_R_N	               , //addr 0x0012  bit2
input  wire        i_MCIO31A_ALERT_R_N                 , //addr 0x0012  bit1
input  wire        i_MCIO31C_ALERT_R_N                 , //addr 0x0012  bit0
...
input  wire        i_NVME1_ALERT_R_N               , //addr 0x0014  bit7
input  wire        i_NVME2_ALERT_R_N               , //addr 0x0014  bit6
input  wire        i_NVME3_ALERT_R_N               , //addr 0x0014  bit5
input  wire        i_NVME4_ALERT_R_N               , //addr 0x0014  bit4

input  wire        i_SW0_NIC_ALERT_R_N              , //addr 0x0015  bit7
input  wire        i_SW1_NIC_ALERT_R_N              , //addr 0x0015  bit6
input  wire        i_SW2_NIC_ALERT_R_N              , //addr 0x0015  bit5
input  wire        i_SW3_NIC_ALERT_R_N              , //addr 0x0015  bit4

input  wire        i_BASE0_VPP_INT_N_R               , //addr 0x0016  bit7
input  wire        i_BASE1_VPP_INT_N_R               , //addr 0x0016  bit6
input  wire        i_BASE2_VPP_INT_N_R               , //addr 0x0016  bit5
input  wire        i_BASE3_VPP_INT_N_R               , //addr 0x0016  bit4

input  wire        i_MB_VPP0_ALT_R_N              , //addr 0x0017  bit7
input  wire        i_MB_VPP1_ALT_R_N              , //addr 0x0017  bit6
input  wire        i_MB_VPP2_ALT_R_N              , //addr 0x0017  bit5
input  wire        i_MB_VPP3_ALT_R_N              , //addr 0x0017  bit4


input  wire        i_PAL_SW_GPU_PRSNT_R_N          , //addr 0x0018  bit7
input  wire        i_PAL_P12V_STBY_FLTB            , //addr 0x0018  bit6
input  wire        i_PAL_P12V_OC                   , //addr 0x0018  bit5
input  wire        i_P12V_SNS_ALERT                , //addr 0x0018  bit4

input  wire        i_NVME1_PRSNT0_R_N	           , //addr 0x0019  bit7
input  wire        i_NVME1_PRSNT1_R_N	           , //addr 0x0019  bit6
input  wire        i_NVME2_PRSNT0_R_N              , //addr 0x0019  bit5
input  wire        i_NVME2_PRSNT1_R_N              , //addr 0x0019  bit4
...
output wire        o_SW0_PEX_PERST_R_N                , //addr 0x001b  bit7 //default 1
output wire        o_SW1_PEX_PERST_R_N                , //addr 0x001b  bit6 //default 1
output wire        o_SW2_PEX_PERST_R_N                , //addr 0x001b  bit5 //default 1
output wire        o_SW3_PEX_PERST_R_N                , //addr 0x001b  bit4 //default 1


//NIC
output wire        o_PAL_RST_SW0_3_NIC_VPP1_N_R              , //addr 0x001c  bit7 //default 0
output wire        o_PAL_RST_SW0_VPP2_N_R              , //addr 0x001c  bit6 //default 0
output wire        o_PAL_RST_SW1_VPP2_N_R              , //addr 0x001c  bit5 //default 0
output wire        o_PAL_RST_SW2_VPP2_N_R              , //addr 0x001c  bit4 //default 0
output wire        o_PAL_RST_SW3_VPP2_N_R              , //addr 0x001c  bit3 //default 0



//CLK OE
output wire        o_SW0_NPU_CLK_OE_N_R                , //addr 0x001d  bit7 //default 1
output wire        o_SW1_NPU_CLK_OE_N_R                , //addr 0x001d  bit6 //default 1
output wire        o_SW2_NPU_CLK_OE_N_R                , //addr 0x001d  bit5 //default 1
output wire        o_SW3_NPU_CLK_OE_N_R                , //addr 0x001d  bit4 //default 1
output wire        o_SW0_MCIO2_CLK_OE_N_R              , //addr 0x001d  bit3 //default 1
output wire        o_SW1_MCIO2_CLK_OE_N_R              , //addr 0x001d  bit2 //default 1
output wire        o_SW2_MCIO2_CLK_OE_N_R              , //addr 0x001d  bit1 //default 1
output wire        o_SW3_MCIO2_CLK_OE_N_R              , //addr 0x001d  bit0 //default 1
...
input  wire        i_NPU1_4_WAKE_R_N                  , //addr 0x0023  bit7 
input  wire        i_NPU5_8_WAKE_R_N                  , //addr 0x0023  bit6 
input  wire        i_NIC1_4_WAKE_R_N                  , //addr 0x0023  bit5 
input  wire        i_NIC5_8_WAKE_R_N                  , //addr 0x0023  bit4 

input  wire        i_NIC1A_PRSNT0_R_N                  , //addr 0x0024 bit7 
input  wire        i_NIC1A_PRSNT1_R_N                  , //addr 0x0024 bit6 
input  wire        i_NIC1C_PRSNT0_R_N                  , //addr 0x0024 bit5 
input  wire        i_NIC1C_PRSNT1_R_N                  , //addr 0x0024 bit4 
input  wire        i_NIC2A_PRSNT0_R_N                  , //addr 0x0024 bit3 
input  wire        i_NIC2A_PRSNT1_R_N                  , //addr 0x0024 bit2 
input  wire        i_NIC2C_PRSNT0_R_N                  , //addr 0x0024 bit1 
input  wire        i_NIC2C_PRSNT1_R_N                  , //addr 0x0024 bit0 

input  wire        i_NIC3A_PRSNT0_R_N                  , //addr 0x0025 bit7 
input  wire        i_NIC3A_PRSNT1_R_N                  , //addr 0x0025 bit6 
input  wire        i_NIC3C_PRSNT0_R_N                  , //addr 0x0025 bit5 
input  wire        i_NIC3C_PRSNT1_R_N                  , //addr 0x0025 bit4 
input  wire        i_NIC4A_PRSNT0_R_N                  , //addr 0x0025 bit3 
input  wire        i_NIC4A_PRSNT1_R_N                  , //addr 0x0025 bit2 
input  wire        i_NIC4C_PRSNT0_R_N                  , //addr 0x0025 bit1 
input  wire        i_NIC4C_PRSNT1_R_N                  , //addr 0x0025 bit0 
...
input  wire        i_P3V3_STBY_PG                  , //addr 0x0027  bit7  
input  wire        i_P12V_PG                       , //addr 0x0027  bit6  
input  wire        i_PAL_P12V_STBY_PG              , //addr 0x0027  bit5  
input  wire        i_PAL_SW_PWR_PG                 , //addr 0x0027  bit4  
input  wire        i_CT_P1V25_SW0_PG               , //addr 0x0027  bit3  
input  wire        i_CT_P1V25_SW1_PG               , //addr 0x0027  bit2  
input  wire        i_CT_P1V25_SW2_PG               , //addr 0x0027  bit1  
input  wire        i_CT_P1V25_SW3_PG               , //addr 0x0027  bit0  

input  wire        i_NIC5A_PRSNT0_R_N               , //addr 0x0028  bit7 
input  wire        i_NIC5A_PRSNT1_R_N               , //addr 0x0028  bit6 
input  wire        i_NIC5C_PRSNT0_R_N               , //addr 0x0028  bit5 
input  wire        i_NIC5C_PRSNT1_R_N               , //addr 0x0028  bit4 
input  wire        i_NIC6A_PRSNT0_R_N               , //addr 0x0028  bit3 
input  wire        i_NIC6A_PRSNT1_R_N               , //addr 0x0028  bit2 
input  wire        i_NIC6C_PRSNT0_R_N               , //addr 0x0028  bit1 
input  wire        i_NIC6C_PRSNT1_R_N               , //addr 0x0028  bit0 

input  wire        i_NIC7A_PRSNT0_R_N             , //addr 0x0029  bit7 
input  wire        i_NIC7A_PRSNT1_R_N             , //addr 0x0029  bit6 
input  wire        i_NIC7C_PRSNT0_R_N             , //addr 0x0029  bit5 
input  wire        i_NIC7C_PRSNT1_R_N             , //addr 0x0029  bit4 
input  wire        i_NIC8A_PRSNT0_R_N             , //addr 0x0029  bit3 
input  wire        i_NIC8A_PRSNT1_R_N             , //addr 0x0029  bit2 
input  wire        i_NIC8C_PRSNT0_R_N             , //addr 0x0029  bit1 
input  wire        i_NIC8C_PRSNT1_R_N             , //addr 0x0029  bit0 
...
assign  o_SW0_PEX_PERST_R_N             = r_reg_001b[7] ;
assign  o_SW1_PEX_PERST_R_N             = r_reg_001b[6] ;
assign  o_SW2_PEX_PERST_R_N             = r_reg_001b[5] ;
assign  o_SW3_PEX_PERST_R_N             = r_reg_001b[4] ;


assign  o_PAL_RST_SW0_3_NIC_VPP1_N_R     = r_reg_001c[7] ;
assign  o_PAL_RST_SW0_VPP2_N_R           = r_reg_001c[6] ;
assign  o_PAL_RST_SW1_VPP2_N_R           = r_reg_001c[5] ;
assign  o_PAL_RST_SW2_VPP2_N_R           = r_reg_001c[4] ;
assign  o_PAL_RST_SW3_VPP2_N_R           = r_reg_001c[3] ;



assign  o_SW0_NPU_CLK_OE_N_R             = r_reg_001d[7] ;
assign  o_SW1_NPU_CLK_OE_N_R             = r_reg_001d[6] ;
assign  o_SW2_NPU_CLK_OE_N_R             = r_reg_001d[5] ;
assign  o_SW3_NPU_CLK_OE_N_R             = r_reg_001d[4] ;
assign  o_SW0_MCIO2_CLK_OE_N_R           = r_reg_001d[3] ;
assign  o_SW1_MCIO2_CLK_OE_N_R           = r_reg_001d[2] ;
assign  o_SW2_MCIO2_CLK_OE_N_R           = r_reg_001d[1] ;
assign  o_SW3_MCIO2_CLK_OE_N_R           = r_reg_001d[0] ;
...
assign w_ram_0018 = {
                     i_PAL_SW_GPU_PRSNT_R_N          ,
                     i_PAL_P12V_STBY_FLTB            ,
                     i_PAL_P12V_OC                   ,
                     i_P12V_SNS_ALERT                ,
                     1'b0                            ,
                     1'b0                            ,
