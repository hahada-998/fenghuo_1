...
//change iclk from 2M to 50M --2022-12-15
...
//////////////////////////////////////////////////////////////////////////////////
	 ...
	 localparam  T_1mS_50M  =  16'd50000;
     localparam  T_2mS_2M  =  12'd4000;
	 localparam  T_2mS_50M  =  17'd100000;
...
//
counter2 #( .MAX_COUNT(T_2mS_50M) ) PWR_OK_2mS_DLY
( .iClk        (iClk),
.iRst_n        (iRst_n),
...
.iCntEn        (oBMC_PWR_OK),
.iLoad         (!(oBMC_PWR_OK)),
.iSetCnt       (T_2mS_50M[16:0]),  // set the time out time as 2ms
.oDone         (wPWRGD_All_VRs_DLY_2mS),
.oCntr         ( )
);

counter2 #( .MAX_COUNT(T_1mS_50M) ) PWR_UP_DOWN_1mS_DLY
( .iClk         (iClk),
.iRst_n        (iRst_n),
...
.iCntEn        (wCNT_RST_N),
.iLoad         (!(wCNT_RST_N)),
.iSetCnt       (T_1mS_50M[15:0]),  // set the time out time as 1ms
.oDone         (wDLY_1mS),
.oCntr         ( )
);
