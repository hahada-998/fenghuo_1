...
PGM_DEBOUNCE #(.SIGCNT(3), .NBITS (2'b11), .ENABLE(1'b1)) db_inst_amd_cpu_prsnt(   
  ...
  .rst(~pon_reset_n),
  .din({  
                (i_P0_PRSNT_N & w_cpu_module_p0_prsnt_n) ,	//01 P0 存在与 CPU 模块 P0 存在的与运算信号（低电平有效），P0 及对应 CPU 模块存在的复合指示
                (i_P1_PRSNT_N & w_cpu_module_p1_prsnt_n) ,  //02 P1 存在与 CPU 模块 P1 存在的与运算信号（低电平有效），P1 及对应 CPU 模块存在的复合指示
...
// assign  w_pal_pwrbtn_n_r = w_pwrbtn_to_pch_n & w_bmc_ctl_pwrbtn_n ;  //o_FM_CPLD_PWRvBTN_OUT_N    cpld TO pch
...
assign  o_P0_PWR_BTN_R_N                                       =   w_pwr_btn;
assign  o_P1_PWR_BTN_N                                         =   w_pwr_btn;
...
assign  o_PAL_PVCC_HPMOS_EN_R                          =   1'b1  ;
assign  o_PAL_P12V_CPU1_ON                             =   1'b1  ;
assign  o_PAL_P12V_CPU0_ON                             =   1'b1  ;
