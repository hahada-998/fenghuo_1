...
input  wire i_pwrbtn_n,
input  wire i_slps4_n,

input  wire i_bmc_sbtn_poweron,     //generate 500ms pulse
input  wire i_bmc_lbtn_powerdown,   //generate 6s pulse
input  wire i_bmc_sbtn_powerdown,   //generate 500ms pulse
input  wire i_bmc_sbtn_wc     ,     // W0C
input  wire i_bmc_lbtn_wc     ,     // W0C
input  wire i_bmc_sbtn_sys_wc ,     // W0C

output wire o_bmc_sbtn_poweron_done,
output wire o_bmc_lbtn_powerdown_done,
output wire o_bmc_sbtn_powerdown_done,
output wire o_sbtn_pwron_evt   ,
output wire o_lbtn_pwrdown_evt ,
output wire o_sbtn_sysrst_evt  ,
...
begin
	...
	begin
	    if(w_pwrbtn_neg  )//i_pwrbtn_n   2023-6-1
		    r_pwrbtn_counter  <= 0;
