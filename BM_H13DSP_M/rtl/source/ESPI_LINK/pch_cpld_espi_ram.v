...
input   wire                i_clk_10ms          , // 10ms 时钟信号，用于定时控制

input   wire [15:0]         i_espi_addr         , // eSPI 地址信号，16 位
input   wire [7:0]          i_espi_date_out     , // eSPI 写数据信号，8 位
output  wire [7:0]          o_espi_date_in      , // eSPI 读数据信号，8 位
...
input   wire [7:0]         i_PRODUCT_GEN_ID_C3, // 产品代数标识，地址 0x00C3
