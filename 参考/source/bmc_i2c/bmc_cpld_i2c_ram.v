...
output wire        o_ctl_rst_i2c2_mux_n_r         , //addr 0x0010 bit6  default 1
output wire        o_ctl_rst_i2c3_mux_n_r          , //addr 0x0010 bit5  default 1
...
//0x0011
input  wire        i_P0_MCIOP0A_NVME0_PRSNT_N_R      , //addr 0x0011 bit7
input  wire        i_P0_MCIOP0C_NVME0_PRSNT_N_R  , //addr 0x0011 bit6
//0x0012
...
//0x0015
input  wire        i_PAL_PE_WAKE_N                     , //addr 0x0015 bit7
input  wire        i_PAL_NODE1_TYPE                    , //addr 0x0015 bit6
input  wire        i_PWRGD_SYS_PWROK_R                 , //addr 0x0015 bit5
// //PSU--0x0015
...
//0x0016
input  wire         i_P0_MCIOP0A_NVME1_PRSNT_N_R    ,   //addr 0x0016 bit7
input  wire         i_P0_MCIOP0C_NVME1_PRSNT_N_R    ,   //addr 0x0016 bit6
//0x0017
...
//0x0023
input  wire        i_PAL_P12V_CPU0_DIMM_OC               , //addr 0x0023 bit7
input  wire        i_PAL_P12V_CPU1_DIMM_OC            , //addr 0x0023 bit6
input  wire        i_PAL_P12V_CPU0_DIMM_GOK           , //addr 0x0023 bit5
input  wire        i_PAL_P12V_CPU1_DIMM_GOK           , //addr 0x0023 bit4
...
input  wire        i_SMB_CPU0_ALERT_N_R         , //addr 0x0024 bit3
...
output wire        o_p0_mciop0a_gpu_throttle_n_r    , //addr 0x0027 default 0
output wire        o_p0_mciop0c_gpu_throttle_n_r    , //addr 0x0027 default 0
...
//0x002b
output wire        o_pal_p12v_cpu0_dimm_on                , //addr 0x002b bit7 default 1
output wire        o_pal_p12v_cpu1_dimm_on                , //addr 0x002b bit7 default 1
...
//0x002c
output wire        o_clk_gen_intr_n_r               , //addr 0x002b bit7 default 1
output wire        o_clk_gen_lol_n_r                , //addr 0x002b bit6 default 1
output wire        o_clk_gen_finc_r                 , //addr 0x002b bit5 default 1
output wire        o_clk_gen_rst_n_r                , //addr 0x002b bit4 default 1
output wire        o_clk_gen_oe_n_r                 , //addr 0x002b bit3 default 1
output wire        o_clk_gen_fdec_r                 , //addr 0x002b bit2 default 1
output wire        o_clk_i2c_sel_r                  , //addr 0x002b bit1 default 1
...
output wire        o_sw_bios_flash_spi_s_r       , //addr 0x0029 bit7 default 0
output wire        o_sw_bios_qspi_s_r            , //addr 0x0029 bit6 default 0
output wire        o_sw_bios_spi_oe              , //addr 0x0029 bit5 default 0
output wire        o_sw_qspi_oe_r                , //addr 0x0029 bit4 default 0
output wire        o_bios_flash_reset_r_n        , //addr 0x0029 bit3 default 1
...
input  wire         i_LEAKAGE_PRSNT_N    , //addr 0x008e
...
assign  o_ctl_rst_i2c2_mux_n_r        = r_reg_0010[6]                         ;
assign  o_ctl_rst_i2c3_mux_n_r       = r_reg_0010[5]                         ;
...
assign  o_p0_mciop0a_gpu_throttle_n_r  = r_reg_0027[5]                         ;
assign  o_p0_mciop0c_gpu_throttle_n_r  = r_reg_0027[4]                         ;
...
assign  o_pal_p12v_cpu0_dimm_on             = r_reg_002b[7]                         ;
assign  o_pal_p12v_cpu1_dimm_on             = r_reg_002b[6]                         ;
...
assign  o_clk_gen_intr_n_r            = r_reg_002c[7]                         ;
assign  o_clk_gen_lol_n_r             = r_reg_002c[6]                         ;
assign  o_clk_gen_finc_r              = r_reg_002c[5]                         ;
assign  o_clk_gen_rst_n_r             = r_reg_002c[4]                         ;
assign  o_clk_gen_oe_n_r              = r_reg_002c[3]                         ;
assign  o_clk_gen_fdec_r              = r_reg_002c[2]                         ;
assign  o_clk_i2c_sel_r               = r_reg_002c[1]                         ;
...
assign w_ram_0023 = {
                     i_PAL_P12V_CPU0_DIMM_OC            ,
                     i_PAL_P12V_CPU1_DIMM_OC            ,
                     i_PAL_P12V_CPU0_DIMM_GOK           ,
                     i_PAL_P12V_CPU1_DIMM_GOK           ,
                     1'b0                               ,
                     1'b0                               ,
					 1'b0                               ,
					 1'b0                            
...
begin
	...
	case(w_i2c_command) 		
		...
		16'h002c: r_i2c_data_in <= r_reg_002c;//RO 
